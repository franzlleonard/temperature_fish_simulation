...
if submitted == True:
    ...
    N_space = ny * nx #computes the number of grid points there are to unravel the matrix later on
    N_time = len(T_frames) #checks the number of times we are simulation
    ...
    svd_buttons = [
        ...
        dict(
            label='Show Oscillation Mode (POD 1)',
            method='update',
            args=[
