...
try:
    ...
    print('')
    print('Please now select the pond material to simulate. Here is the selection:')
    print('- concrete - dirt - wood - sand - volcanic earth - metal')
    material_type = str(input('input the material you want to simulate: '))
    alpha = material_alpha_information.get(material_type)
except ValueError:
    print("Invalid input. Using defaults (4 sides, 100 degrees, 0.5 m).")
    k_sides_shape = 4
    central_temperature = 100
    polygon_radius = 0.5
    fish_lower_bound_temperature = 50
    fish_upper_bound_temperature = 60
