...
def defining_constants():
    ...
    polygon_radius = 1
    return Lx, Ly, nx, ny, dx, dy, alpha, dt, T_final, steps_per_frame, x, y, X, Y, points, polygon_radius
...
try:
    ...
    print("Invalid input. Using square default.")
    k_sides_shape = 4


Lx, Ly, nx, ny, dx, dy, alpha, dt, T_final, steps_per_frame, x, y, X, Y, points, polygon_radius = defining_constants()
